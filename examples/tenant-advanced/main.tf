...
# This example demonstrates a production-ready configuration with multiple features enabled.
...
module "upwind_integration_azure_onboarding" {
  ...
  # Azure configuration - Tenant level with subscription exclusions
  ...
  # Exclude test and sandbox subscriptions
  cloudapi_exclude_subscriptions = [
    "6703683f-8798-4a2d-8705-56738b445911" # sandbox-subscription
  ]
  ...
  # Secure Key Vault with network restrictions
  ...
  # Optional: Custom resource suffix for unique naming
