...
# This example demonstrates excluding specific subscriptions from monitoring.
...
module "upwind_integration_azure_onboarding" {
  ...
  # Exclude specific subscriptions from CloudAPI (discovery)
  cloudapi_exclude_subscriptions = [
    "6703683f-8798-4a2d-8705-56738b445911",
    "7814794g-9809-5b3e-9816-67849c556022"
  ]

  # Exclude specific subscriptions from CloudScanner (scanning)
