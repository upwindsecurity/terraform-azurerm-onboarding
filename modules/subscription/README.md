...
| <a name="input_azure_roles"></a> [azure\_roles](#input\_azure\_roles) | The names of the Azure roles that should be assigned to the service principal. | `list(string)` | <pre>[<br/>  "Reader",<br/>  "Cognitive Services Data Reader"<br/>]</pre> | no |
