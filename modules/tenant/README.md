...
| <a name="input_enable_function_scanning"></a> [enable\_function\_scanning](#input\_enable\_function\_scanning) | If set to true will enable Storage Blob Data Reader role assignment for upwind-cs-vmss-identity | `bool` | `true` | no |
