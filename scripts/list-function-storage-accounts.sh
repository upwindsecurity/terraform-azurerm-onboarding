...
echo ""
echo -e "${GREEN}variable \"dspm_storage_accounts\" {${NC}"
echo -e "${GREEN}  description = \"Storage accounts the DSPM data-plane grants are scoped to (also covers Function App code storage)\"${NC}"
